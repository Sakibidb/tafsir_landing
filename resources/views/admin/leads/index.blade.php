        ...
        <div class="col-12">
            <div class="db-card">
                <div class="db-card-header border-none">
                    <h3 class="db-card-title">Leading Leads</h3>
                ...
                <div class="col-12">
                    <div class="db-table-responsive">
                        <table id="maintable" class="db-table stripe" data-url="{{ route('admin.leads.list') }}">
                            <thead class="db-table-head">
                                <tr class="db-table-head-tr">
                                    <th class="db-table-head-th">Name</th>
                                    <th class="db-table-head-th">Email</th>
                                    <th class="db-table-head-th">Phone</th>
...
@push('js')
    ...
    <script src="{{ asset('backend/js/leads/index.js') }}"></script>
@endpush
